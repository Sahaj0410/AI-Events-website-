    ...
    return (
      ...
      >
        <CardContent className="p-3 flex gap-3">
          <div className="w-20 h-20 rounded-lg shrink-0 relative overflow-hidden">
            {event.coverImage ? (
              <Image
          ...
          <div className="flex-1 min-w-0">
           <h3 className="font-semibold text-sm mb-1 group-hover:text-purple-400 transition-colors line-clamp-2">{event.title}</h3>
