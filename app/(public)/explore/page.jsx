  ...
  <div className='mb-16'>
    <h2 className='text-3xl font-bold mb-6'>
     ...
     <div className='grid grid-cols-2 md:grid-cols-4 gap-4'>
        {categoriesWithCounts.map((category) => {return(
          <Card
          key={category.id}
  ...
  (!popularEvents || popularEvents.length === 0) && (
    <Card className="p-12 text-center" >
      <div className='max-w-md mx-auto space-y-4'>
        ...
        <h2 className='text-muted-foreground'>No events yet</h2>
        <p className='text-muted-foreground'>Be the first one to create an event in your area</p>
